<%@ Page Title="Login" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="TPC_equipo_2.Login" %>
    ...
    <div class="container pt-5" style="width: 500px;">
        <div class="d-flex flex-column justify-content-center gap-3">
            ...
            <div>
                ...
                <asp:Button Text="Ingresar" type="submit" class="btn w-100 m-0" Style="background-color: #0364B8; color: #ffffff;" OnClick="btnIngresar_Click" runat="server" />
            </div>            
        </div>
    </div>
</asp:Content>
